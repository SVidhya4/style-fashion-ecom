...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="myntra.com UI Clone built with HTML and CSS by Sandeep Ahirwar"
    />
    <title>Style</title>
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <!-- Main [ START ] -->
      ...
      <div class="discounts">
        <div class="title1"><h4>MEDAL WORTHY BRANDS TO BAG</h4></div>
        <div class="items">
          <a href="/"
            ><img
          ...
          <a href="/"
            ><img
              src="https://i.ibb.co/M1VhfXN/Discount-5.webp"
              alt="Discount 5"
              width="250"
          /></a>
          <a href="/"
            ><img
              src="https://i.ibb.co/tH9Dcwg/Discount-6.webp"
              alt="Discount 6"
              width="250"
          /></a>
          <a href="/"
      ...
      <div class="categories">
        <div class="title2"><h1 align="center">SHOP BY CATEGORY</h1></div>
        <div class="items">
          <a href="/"
            ><img
              src="https://i.ibb.co/kq2149K/Category-1.jpg"
              alt="Category 1"
              width="200"
          /></a>
          <a href="/"
            ><img
              src="https://i.ibb.co/tM40JMy/Category-2.jpg"
              alt="Category 2"
              width="200"
          /></a>
          <a href="/"
