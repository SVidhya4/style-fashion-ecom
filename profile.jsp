...
<%
    ...
    String email = "- not added -";
    String gender = "- not added -";
    String dateOfBirth = "- not added -";
    String location = "- not added -";

    if (userSession != null) {
        String username = (String) userSession.getAttribute("uname");
        ...
        if (username != null) {
            ...
            try {
                ...
                String sql = "SELECT fname, email, gender, date_of_birth, location FROM users WHERE userid = ?";
                ...
                if (rs.next()) {
                    ...
                    fullName = "Profile details not found.";
                }

            } catch (SQLException sqlEx) {
                sqlEx.printStackTrace();
                fullName = "Error retrieving profile details.";
            } catch (Exception ex) {
                ex.printStackTrace();
            ...
            fullName = "User not logged in."; // No userId in session
        }
    } else {
        fullName = "Session not found."; // No session
    }
%>
...
<head>
    ...
    <title>Style Account - Profile</title>
        ...
        <div class="account-section">
            <div class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a href="order.jsp">Orders & Returns</a></li>
            ...
            <div class="account-content">
                <div class="profile-section">
                    ...
                    <span><button class="logout-button"><a href="logout.jsp">Logout</a></button></span>
                  </div>
                </div>
            </div>
        </div>
